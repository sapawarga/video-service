...
func (m *MockDatabaseI) GetLocationNameByID(ctx context.Context, id int64) (*string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseIMockRecorder) GetLocationNameByID(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLocationNameByID", reflect.TypeOf((*MockDatabaseI)(nil).GetLocationNameByID), ctx, id)
}
